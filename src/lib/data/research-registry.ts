...
export const researchRegistry: ResearchEntry[] = [
	{
		...
		repo_notes:
			'Historical methodology context only in V9; it does not alter the SSOC 2024 headline pressure rank.'
	},
	{
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['historical AIOE source', 'occupation-level exposure comparison'],
		source_keys: ['aioe_2021'],
		claim_ids: [
			'deterministic_no_llm_core',
			'v9_external_comparison_withheld',
			'structural_pressure_not_prediction'
		],
		summary:
			'Provides a published occupation-level AI exposure measure used for historical comparison and methodological context.',
		limitations:
	...
	},
	{
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['potential complementarity context', 'cross-country interpretation'],
		source_keys: ['pizzinelli_theta_2023'],
		claim_ids: ['deterministic_no_llm_core', 'structural_pressure_not_prediction'],
		summary:
			'Provides a cross-country framework for distinguishing AI exposure from potential complementarity with human work.',
		limitations:
			'Designed as a broad labour-exposure framing rather than a Singapore occupation-level calibrated outcome model.',
		repo_notes:
			'V9 reviewed this for an independent potential-complementarity sidecar but withholds every occupation value because the available cross-system mapping and construct replication do not pass the publication gate.'
	},
	{
		...
		status: 'supporting',
		used_for: [
			'frozen January 2026 observed-use artifact',
			'usage-gap framing',
			'task evidence design'
		],
		source_keys: ['anthropic_economic_index_2026'],
		claim_ids: ['deterministic_no_llm_core', 'v9_external_comparison_withheld'],
		summary:
			'Introduces task complexity, skill, purpose, autonomy and success measures using sampled Claude conversations from November 2025.',
		limitations:
			'Observed Claude usage is not a full labour-market census and is still a platform-specific measure.',
		repo_notes:
			'The linked source key identifies a frozen pre-V9 input. V9 treats it as platform-specific observed-use context, never as a Singapore outcome or headline-score weight.'
	},
	{
		...
		status: 'active',
		used_for: [
			'observed exposure definition',
			'US labour-outcome monitoring',
			'near-term impact interpretation'
		],
		source_keys: [],
		claim_ids: [],
		summary:
			'Combines theoretical task capability with work-related Claude usage, weighting automated use more than augmentative use, then tests early US unemployment and hiring patterns.',
		limitations:
			'Uses US outcome data and a platform-linked usage measure, so it still needs Singapore-specific interpretation.',
		repo_notes:
			'Independent external proxy and validation reference only. It is not representative Singapore adoption, an occupation-level displacement probability, or a V9 score weight.'
	},
	{
	...
	},
	{
		...
		type: 'working_paper',
		domains: ['exposure', 'tasks', 'measurement', 'uncertainty'],
		role: 'active_core',
		status: 'active',
		used_for: [
			'V9 headline structural task exposure',
			'official exposure gradients',
			'task-score dispersion'
		],
		source_keys: ['ilo_genai_2025'],
		claim_ids: ['v9_ilo_task_exposure_headline'],
		summary:
			'Builds an ISCO-08-aligned exposure index from nearly 30,000 tasks using worker input, expert review and model predictions, with four exposure gradients defined by mean task exposure and dispersion.',
		limitations:
			'Measures potential task exposure under the assessed technology, not adoption, displacement, wages or Singapore employment outcomes; SSOC-to-ISCO mapping adds uncertainty.',
		repo_notes:
			'The sole V9 headline research source. SSOC 2024 occupations inherit the median across official ISCO matches, with the full mapping range retained; no other research source changes that rank.'
	},
	{
		key: 'onet_database_2024',
		title: 'O*NET Database 30.2 (frozen repository artifact)',
		...
		status: 'supporting',
		used_for: [
			'US task and skill context',
			'crosswalked occupation descriptions',
			'experimental transition context'
		],
		source_keys: [
		...
		repo_notes:
			'The checked-in O*NET text files are the frozen 30.2 artifact. External US context only; they do not alter Singapore V9 exposure, demand or risk interpretation.'
	},
	{
		key: 'onet_database_30_3',
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['Current research-register reference; not a V9 model input'],
		source_keys: [],
		claim_ids: ['latest_onet_reference_not_v9_input'],
		summary:
			'Current O*NET release reviewed for US task and occupation context after the repository snapshot was frozen.',
		limitations:
			'No 30.3 source files are checked into this release. O*NET is US-based and does not represent Singapore task content directly.',
		repo_notes:
			'Research currency record only. The frozen repository artifact remains 30.2, and neither version changes the Singapore V9 headline.'
	},
	{
		key: 'bls_oews_2025',
	...
	},
	{
		...
		role: 'validation',
		status: 'active',
		used_for: ['US preview context', 'external directional validation'],
		source_keys: ['bls_projections_2024_2034'],
		claim_ids: [
			'us_preview_context_only',
			'bls_cross_check_directional_only',
			'v9_no_singapore_employment_inference'
		],
		summary:
			'Provides official US occupation projections used for the US preview and directional research comparisons.',
		limitations:
			'This is US evidence and should not be interpreted as Singapore occupation outcome truth.',
		repo_notes:
			'V9 does not use US projected employment to infer Singapore employment, jobs affected or wage pools.'
	},
	{
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['workflow-level productivity evidence', 'heterogeneity interpretation'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Shows heterogeneous productivity gains from generative-AI assistance in one customer-support workflow.',
		limitations:
			'The effect size is workflow-specific and should not be generalized into a universal augmentation constant.',
		repo_notes:
			'Interpretation only in V9; its effect size is never transferred into an occupation-level Singapore augmentation or risk score.'
	},
	{
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['jagged capability evidence', 'workflow heterogeneity'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Highlights that AI gains are jagged across tasks and expertise levels rather than smooth across a whole occupation.',
		limitations:
			'The 758-participant BCG experiment tested selected consulting tasks; its effects cannot be transferred to every workflow or occupation.',
		repo_notes:
			'Interpretation only in V9; constrained experiments do not calibrate a Singapore occupation score.'
	},
	{
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['work-pattern evidence', 'workflow productivity context'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Finds time savings in email and outside normal working hours after enterprise Copilot access, but no detected change in the quantity or composition of tasks beyond those savings.',
		limitations:
			'The study measures work patterns in a specific enterprise setting and does not identify occupation-level employment effects.',
		repo_notes:
			'Used to show that measured time savings need not imply more completed tasks; it is not a V9 score input.'
	},
	{
		...
		role: 'validation',
		status: 'active',
		used_for: ['task concentration interpretation', 'labour-demand validation'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Shows that mean exposure and concentration of exposure in a few tasks can have different labour-demand implications.',
		limitations:
			'The firm-task estimates are US-specific and do not identify a transferable occupation-level adjustment for Singapore.',
		repo_notes:
			'V9 uses this to interpret why equal mean exposure can lead to different outcomes; it does not apply a concentration buffer to the headline score.'
	},
	{
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['exposure-index critique', 'demand-response framing'],
		source_keys: [],
		claim_ids: [],
		summary:
		...
		repo_notes:
			'Used as a readable statement of missing economic mechanisms. V9 presents direct demand evidence separately and does not turn it into an exposure modifier.'
	},
	{
		...
		repo_notes:
			'Experimental transition context only; it does not recommend a pathway or alter the V9 pressure rank.'
	},
	{
		...
		limitations:
			'Aggregate exposure and complementarity shares at economy level, not occupation-by-occupation scores; it uses the IMF framework rather than the ILO 2025 V9 headline measure.',
		repo_notes:
			'The most directly relevant external Singapore benchmark, used for directional comparison rather than formal calibration or score weighting.'
	},
	{
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['workplace adoption context', 'measurement design'],
		source_keys: [],
		claim_ids: [],
		summary:
		...
		repo_notes:
			'US adoption context only; it does not calibrate Singapore adoption or change V9 occupation ranks.'
	},
	{
		...
		role: 'validation',
		status: 'active',
		used_for: ['early realised-outcome evidence', 'task-reorganisation evidence'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Links Danish adoption surveys to administrative records and finds widespread task reorganisation but precise null average effects on earnings and recorded hours two years after ChatGPT, ruling out effects larger than 2%.',
		limitations:
			'Denmark-specific early evidence; null average earnings and hours effects do not rule out distributional changes, hiring effects or longer-run displacement.',
		repo_notes:
			'Issued May 2025 and revised March 2026. Validation and interpretation only: it supports separating task pressure from realised outcomes, not a numeric shrinkage factor.'
	},
	{
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['frontier capability context', 'scenario monitoring'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Tracks the human task duration associated with a 50% model success rate and was updated on 8 May 2026 with newer frontier-model measurements.',
		limitations:
			'The benchmark is primarily software engineering, machine learning and cybersecurity; task duration is difficulty for a low-context expert, not autonomous runtime or a share of jobs automatable.',
		repo_notes:
			'Scenario context only. METR time horizons neither alter the V9 occupation score nor forecast Singapore job loss.'
	},
	{
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['measurement philosophy', 'uncertainty design'],
		source_keys: [],
		claim_ids: [],
		summary:
		...
		repo_notes:
			'Used to support transparent uncertainty and task-level measurement rather than heuristic confidence labels.'
	},
	{
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['early-career hiring evidence', 'US labour-outcome monitoring'],
		source_keys: [],
		claim_ids: [],
		summary:
		...
		repo_notes:
			'Used as an early-warning context signal only. V9 does not apply age or seniority modifiers to an occupation score.'
	},
	{
	...
	},
	{
		...
		repo_notes:
			'Used to disclose annotator and model instability in task-exposure research. The ILO score remains the V9 headline input, with uncertainty shown rather than averaged away.'
	},
	{
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['transition-network context', 'reallocation interpretation'],
		source_keys: [],
		claim_ids: [],
		summary:
		...
		limitations:
			'US transition-network data; Singapore-specific mobility networks are not yet measured, so similarity cannot establish feasible worker transitions.',
		repo_notes:
			'Experimental transition context only; structural similarity is not evidence that a Singapore worker can or should make a particular move.'
	},
	{
		key: 'yin_ogut_2026',
		...
		repo_notes:
			'Core disclosure for every platform-derived observed-use layer. Platform evidence remains a separate proxy and never changes the V9 headline rank.'
	},
	{
		key: 'anthropic_economic_index_cadences_2026',
		...
		type: 'report',
		domains: ['tasks', 'measurement', 'productivity', 'context'],
		role: 'supporting_context',
		status: 'supporting',
		used_for: [
			'latest Claude usage context',
			'agentic-output measurement',
			'user-expectations context'
		],
		source_keys: [],
		claim_ids: [],
		summary:
			'Updates the Economic Index with continuously sampled Claude usage, output classifications across conversations and API traffic, and a linked survey of about 9,700 users.',
		limitations:
			'Claude users and products are selected populations; self-reported expectations are not labour outcomes, and the report does not establish occupation-level Singapore adoption.',
		repo_notes:
			'The current Anthropic usage reference through the V9 cutoff. It is an independent platform proxy and does not replace the frozen January artifact or change the headline score.'
	},
	{
		key: 'openai_jobs_transition_2026',
		...
		type: 'report',
		domains: ['tasks', 'complementarity', 'forecast', 'context'],
		role: 'supporting_context',
		status: 'supporting',
		used_for: [
			'risk-profile interpretation',
			'human-centrality framing',
			'demand-response framing'
		],
		source_keys: [],
		claim_ids: [],
		summary:
			'Classifies 921 US occupations using technical task capability, continued human centrality and possible demand response to distinguish higher automation concern, reorganisation, potential growth and less immediate change.',
		limitations:
			'A scenario framework rather than a causal forecast; its US occupation mappings, human-centrality judgements and demand assumptions are not calibrated to Singapore.',
		repo_notes:
			'Used to structure plain-language risk profiles. Its categories and percentages are not imported as Singapore scores or predictions.'
	},
	{
		key: 'openai_agents_transforming_work_2026',
		...
		type: 'report',
		domains: ['tasks', 'productivity', 'measurement', 'context'],
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['agentic-work context', 'long-horizon task evidence', 'cross-functional work context'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Describes longer-horizon Codex use, cross-functional task execution and rapid non-developer adoption among sampled users and within OpenAI.',
		limitations:
			'Frontier-user and vendor-workplace evidence with model-estimated task horizons; it is highly selected and not representative of occupations or Singapore firms.',
		repo_notes:
			'Capability and workflow context only. It does not provide an occupation exposure score, adoption rate or employment outcome for Singapore.'
	},
	{
		key: 'openai_work_at_frontier_2026',
		...
		type: 'report',
		domains: ['tasks', 'mobility', 'measurement', 'context'],
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['task-crossover evidence', 'synthetic-role interpretation', 'job-redesign context'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Analyzes more than 800,000 messages from US ChatGPT users and finds that 43.5% of occupation-specific messages concern tasks associated with another occupation after generic work is excluded.',
		limitations:
			'Platform users, inferred occupations and message classifications are not a workforce sample; task crossover is not occupational mobility, employment growth or displacement.',
		repo_notes:
			'Supports showing that job boundaries can change and why synthetic roles are useful query layers. It does not validate synthetic-role weights or change V9 ranks.'
	},
	{
		key: 'microsoft_working_with_ai_2025',
		...
		type: 'working_paper',
		domains: ['tasks', 'exposure', 'measurement', 'context'],
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['external applicability comparison', 'observed-use interpretation'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Maps 200,000 privacy-scrubbed Bing Copilot conversations to work activities, task success and scope to estimate US occupation-level AI applicability.',
		limitations:
			'Bing Copilot usage from January to September 2024 is platform-selected, difficult to separate into work and leisure, US/O*NET-based, and limited to chatbot activity.',
		repo_notes:
			'External observed-use comparison only. Microsoft explicitly cautions that applicability does not measure job replacement; it is not a Singapore score weight.'
	},
	{
		key: 'microsoft_future_of_work_2026',
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['work-design synthesis', 'uneven-benefits context', 'human-expertise context'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Synthesizes Microsoft and external field, lab and theory research on productivity, collaboration, learning, judgement and the uneven distribution of workplace AI benefits.',
		limitations:
			'A broad vendor-authored synthesis rather than a single causal estimate, occupation dataset or Singapore study.',
		repo_notes:
			'Interpretation and research-routing context only; it does not support a universal augmentation factor or occupation-level outcome claim.'
	},
	{
		key: 'manning_aguirre_adaptive_capacity_2026',
		title: 'How Adaptable Are American Workers to AI-Induced Job Displacement?',
		authors: ['Sam J. Manning', 'Tomas Aguirre'],
		year: 2026,
		...
		doi: '10.3386/w34705',
		type: 'working_paper',
		domains: ['mobility', 'uncertainty', 'context'],
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['adaptive-capacity framing', 'worker-vulnerability interpretation'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Constructs a US occupation-level adaptive-capacity index and shows that exposure alone obscures large differences in workers’ resources for managing a transition if displacement occurs.',
		limitations:
			'US worker characteristics and a conditional displacement scenario; the index does not estimate whether displacement will occur and cannot be transferred to Singapore without local microdata.',
		repo_notes:
	...
	},
	{
		...
		doi: '10.3386/w34854',
		type: 'working_paper',
		domains: ['tasks', 'augmentation', 'productivity', 'context'],
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['technical-change taxonomy', 'new-task interpretation', 'policy context'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Distinguishes labour-augmenting, capital-augmenting, automating, expertise-levelling and new-task-creating technologies, arguing that only new-task creation is unambiguously pro-worker.',
		limitations:
			'A conceptual and policy framework, not an occupation-level empirical measure or evidence that current AI systems will follow a particular path.',
		repo_notes:
			'Used to keep automation, productivity, expertise and new-work channels conceptually separate; it is not a scoring formula.'
	},
	{
		key: 'althoff_reichardt_task_specific_change_2026',
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['general-equilibrium context', 'skill and task reallocation framing'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Models how task-specific augmentation, automation and simplification can change comparative advantage, occupations, skills and wages in general equilibrium.',
		limitations:
			'Model-based scenario results depend on estimated US task and skill structures and assumed AI progress and adoption costs; they are not observed Singapore outcomes.',
		repo_notes:
			'Used to explain why partial-equilibrium exposure rankings cannot predict wage or employment outcomes. It does not supply a V9 modifier.'
	},
	{
		key: 'oecd_employment_outlook_2026',
		title: 'OECD Employment Outlook 2026: Geographic Disparities in Jobs and Incomes',
		authors: ['OECD'],
		year: 2026,
		published_at: '2026-07-07',
		publisher: 'OECD Publishing',
		url: 'https://www.oecd.org/en/publications/oecd-employment-outlook-2026_7e710f54-en/full-report.html',
		doi: '10.1787/7e710f54-en',
		type: 'report',
		domains: ['validation', 'forecast', 'mobility', 'context'],
		role: 'validation',
		status: 'active',
		used_for: ['international labour-market context', 'regional and youth-outcome interpretation'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Finds resilient but weakening OECD labour markets, rising difficulty for young entrants, large regional disparities and little evidence to date of broad AI-driven job loss.',
		limitations:
			'Cross-country synthesis with heterogeneous source years and exposure measures; it does not isolate causal AI effects or provide detailed Singapore occupation estimates.',
		repo_notes:
			'Current international validation context through the V9 cutoff. It informs interpretation but not the Singapore headline score.'
	},
	{
		key: 'costa_frontier_ai_measurement_2026',
		title: 'Frontier AI Forecasting Has a Measurement Problem: An Audit of Progress Evidence',
		authors: ['Fabricio F. Costa'],
		year: 2026,
		published_at: '2026-08-14',
		publisher: 'arXiv',
		url: 'https://arxiv.org/abs/2608.14903',
		doi: '10.48550/arXiv.2608.14903',
		type: 'working_paper',
		domains: ['measurement', 'uncertainty', 'forecast'],
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['capability-forecast uncertainty', 'benchmark-version disclosure'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Audits public frontier-capability evidence through 12 August 2026 and documents sparse joins, benchmark succession breaks and concentrated provenance that complicate extrapolation.',
		limitations:
			'A single-author preprint and audit sample rather than a census; it diagnoses measurement weaknesses but does not supply a replacement capability or labour-market scalar.',
		repo_notes:
	...
	},
	{
		...
		role: 'supporting_context',
		status: 'supporting',
		used_for: ['current global usage context', 'country-level adoption comparison'],
		source_keys: [],
		claim_ids: [],
		summary:
			'Publishes Q2 2026 country-level ChatGPT usage patterns and distinguishes output-producing or task-completing use from information-seeking use.',
		limitations:
			'Reflects individual ChatGPT accounts rather than firms or the workforce, includes work-use classifications rather than verified jobs, and uses self-reported age for age patterns.',
		repo_notes:
			'Latest global platform-use context through the V9 cutoff. Any Singapore view remains a platform signal and cannot replace MOM or IMDA adoption evidence.'
	}
];
