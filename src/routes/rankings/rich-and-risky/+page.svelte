		...
		mainEntity: [
			{
				...
				acceptedAnswer: {
					'@type': 'Answer',
					text: `Several occupations earning above ${currency} 5,000/month face high structural AI displacement pressure (30%+). These roles combine high AI task overlap with relatively low human bottlenecks, despite strong wages.`
				}
			},
			{
				'@type': 'Question',
